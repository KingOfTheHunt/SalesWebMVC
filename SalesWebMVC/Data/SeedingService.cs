...
namespace SalesWebMVC.Data
{
    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
            // Verifica se já existe dados no banco de dados
            ...
            // Adicioando os departamentos ao context
            _context.Department.AddRange(d1, d2, d3, d4);

            // Adicionando os vendedores ao context
            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6);

            // Adicionando as vendas ao context
