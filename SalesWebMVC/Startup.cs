...
namespace SalesWebMVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Adicionando a dependência do SalesRecordService
        ...
        {
            // Configurando o Locale da aplicação.
            var locale = new CultureInfo("en-US");
            var localizationOptions = new RequestLocalizationOptions()
            {
                DefaultRequestCulture = new RequestCulture(locale),
                SupportedCultures = new List<CultureInfo>() { locale },
                SupportedUICultures = new List<CultureInfo>() { locale }
            };
